...
/**
 * Query session in the network architecture.
 *
 ...
 */
final class Query extends Progress {
  /** Performance. */
   ...
   */
  Query(final String qu, final Context c) {
   ...
   * @throws IOException I/O Exception
   */
  void execute(final boolean iter, final OutputStream out,
    ...
    try {
      ...
      try {
        ...
        final PrintOutput po = PrintOutput.get(out);

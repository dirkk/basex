...
public interface Commands {
  ...
  /** Command string: "replication-start-master". */
  String REPLICATION_START_MASTER = "repl-start-master";
  /** Command string: "replication-start-slave". */
  String REPLICATION_START_SLAVE = "repl-start-slave";
